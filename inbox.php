<?php
    ...
    session_start();
    $messages = new Messages($_SESSION['userId']);
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="sentbox.php">Gönderilenler</a></li>
                            <li><a href="newmessage.php">Yeni İleti Oluştur</a></li>
                        </ul>
                    </li>
                    <li>                
                        ...
                        <div class="col-md-10">   
                            ...
                            <?php 
                                echo "<div class='row row-records-titles'>"
                                        ."<div class='col-md-5 col-xs-5'><h4><b></b></h4></div>"
                                        ."<div class='col-md-1 col-xs-1 arrow-buttons-left' id='.$page.'><h4><b><</b></h4></div>"
                                        ."<div class='col-md-1 col-xs-1 arrow-buttons-right' id='.$page.'><h4><b>></b></h4></div>"
                                        ."<div class='col-md-5 col-xs-5'><h4><b></b></h4></div>"
                                    ."</div>";
                            
                                if(($page*10) > count($messages->getMessages())) {
                                    $max = count($messages->getMessages());
                                }
                                else {
                                    $max = $page*10;
                                }
                                
                                for ($index = ($page*10)-10; $index < count($messages->getMessages()); $index++) {
                                    echo "<div class='row row-records ".(($index % 2 == 0) ? 'light-line' : 'dark-line')."' id='row".$messages->getMessages()[$index]["id"]."'>"
                                            ."<div class='col-md-2 col-xs-3' id='sendername".$messages->getMessages()[$index]["id"]."'>".$messages->getMessages()[$index]["sender_name"]."</div>"
                                            ."<div class='col-md-3 col-xs-4' id='message".$messages->getMessages()[$index]["id"]."'>".$messages->getMessages()[$index]["message"]."</div>"
                                            ."<div class='col-md-1' id='address".$messages->getMessages()[$index]["id"]."'></div>"
                                            ."<div class='col-md-2' id='phone".$messages->getMessages()[$index]["id"]."'></div>"
                                            ."<div class='col-md-1' id='price".$messages->getMessages()[$index]["id"]."'></div>"
                                            ."<div class='col-md-2 col-xs-3' id='sendtime".$messages->getMessages()[$index]["id"]."'>".$messages->getMessages()[$index]["sendtime"]."</div>"
                                            ."<div class='col-md-1 col-xs-1 row-buttons' id='buttons".$messages->getMessages()[$index]["id"]."'>"
                                                ."<img class='deleteButton' id='deleteButton".$messages->getMessages()[$index]["id"]."' src='./images/delete.png'/>"
                                            ."</div>"
                                        ."</div>";
                                }
                            ?>
